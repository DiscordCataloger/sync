...
const SelectFriends = ({ onClose }) => {
  return (
    <div className="max-w-md mx-auto mt-8 rounded-lg border border-gray-300 shadow-lg bg-white p-6 ">
      ...
      <p className="text-gray-500 mb-4 text-center">You don't have any friends to add!</p>
