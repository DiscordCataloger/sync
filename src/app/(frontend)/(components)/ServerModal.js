    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center text-black z-30">
      <div className="bg-blue-50 rounded-lg p-6 w-96 shadow-lg relative">
        <IoIosClose 
          ...
          onClick={onClose}
        />
        <h2 className="text-lg font-semibold text-center">Customize Your Server</h2>
        ...
        />
        <p className='text-[10px] mb-2'>By creating a server, you agree to Discord's <a href="#" className="text-blue-500">Community Guidelines.</a></p>
