  ...
  return (
    <div className="absolute z-30 h-auto w-100 mx-24 my-96 rounded-lg border border-gray-300 shadow-lg bg-blue-100 text-black">
      ...
      <div className="flex mb-2 ml-2">
        <button className="px-1 py-1 text-sm font-medium text-black bg-blue-300 rounded hover:bg-blue-200">For You</button>
        <button className="px-1 py-1 text-sm font-medium text-black bg-blue-300 rounded hover:bg-blue-200 mx-2">Unread</button>
        <button className="px-1 py-1 text-sm font-medium text-black bg-blue-300 rounded hover:bg-blue-200">Mentions</button>
      </div>
      <div className='bg-white p-4 rounded-lg max-h-40 overflow-y-hidden'> 
        {messages.map((message) => (
          <div key={message.id} className="flex items-center border-b border-gray-200 py-2">
